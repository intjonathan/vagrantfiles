...
#An Ubuntu 14.04 OSSEC server node
node 'trustyossecserver.local' {
...
#An Ubuntu 12.04 OSSEC server node
node 'preciseossecserver.local' {
...
#CentOS 6 OSSEC server node
node 'centos6ossecserver.local' {
...
#A CentOS 7 OSSEC server node
node 'centos7ossecserver.local' {
...
#A Debian 7 OSSEC server node
node 'debian7ossecserver.local' {
...
node 'osseclogging.local' {
  ...
  ::apache::vhost { 'kibana.osseclogging.local_non-ssl':
    port            => 80,
