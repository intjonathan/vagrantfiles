class profile::icinga2::server::objects {
  ...
  icinga2::object::dependency { "usermail to mailrelay":
    object_name => "usermail_dep_on_mailrelay",
    #hieravaluereplace
    parent_host_name => 'mailrelay.local',
    child_host_name => 'usermail.local',
    target_dir => '/etc/icinga2/objects/dependencies',
    target_file_name => "usermail_to_mailrelay.conf",
  }

  #Apply_dependency object to test out this PR: https://github.com/Icinga/puppet-icinga2/pull/28
  icinga2::object::apply_dependency { 'usermail_dep_on_mailrelay':
    #hieravaluereplace
    parent_host_name => 'mailrelay.local',
